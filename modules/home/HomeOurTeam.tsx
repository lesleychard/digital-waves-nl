...
const TEAM_MEMBERS = [
  {
    ...
    profile: (
      <Typography>
        Lesley is an app designer and developer living in St. John’s, NL. After
        designing her first webpage at nine years old, Lesley started freelance
        web designing at sixteen. As a result of her finding a passion for
        technology at an early age, she pursued a B.Sc. in computer science from
        Memorial University. She currently works for Zorbit’s by Carnegie
        Learning where she designs apps for early education. Lesley is also
        Chapter Lead with Canada Learning Code, where she delivers coding and
        design workshops to women, kids and teachers.
      </Typography>
    ),
  },
  {
    ...
    profile: (
      <>
        <Typography gutterBottom>
          Trinalynn is a community advocate dedicated to projects that shift
          socialized norms and work towards fundamental change. She is
          enthusiastic about her role at WRDC which empowers girls in choosing
          STEM and skilled trades career paths to advance women’s
          representation.
        </Typography>
        <Typography gutterBottom>
          She is current chair of the CBS Community Garden and operator of a
          market-garden farm, both with the goal of cultivating societal
          ownership over food security. As a volunteer first responder and
          executive member of the Canadian Ski Patrol – NL Zone, she promotes
          safe outdoor recreation in all seasons for mental well-being.
          Trinalynn’s Master of Arts’ thesis in Political Science explored how
          to improve networking amongst organizations to propel social change.
        </Typography>
  ...
  },
  {
    ...
    profile: (
      <Typography>
        Sally Marchand is the Program Manager of the Women in Science and
        Engineering - Atlantic Region (WISEatlantic) program which aims to shift
        gendered STEM stereotypes by empowering girls to consider STEM-based
        careers by raising their awareness of the diversity of jobs within these
        fields. Sally holds a BSc and BEd from Mount Saint Vincent University.
  ...
  },
  {
    ...
    profile: (
      <Typography>
        With experience in design, quality assurance, interactive media, and
        marketing, I have a unique perspective when it comes to designing
        thoughtful, elegant experiences backed by solid research and testing. I
        am curious and inquisitive, and I love to learn new things. I’m always
        looking for the ‘why’ behind something and am eager to dig deep into a
        problem.
      </Typography>
    ),
  },
  ...
  },
  {
    ...
    profile: (
      <Typography>
        ...
        province where she now works for Kraken Robotics. She recognizes that
