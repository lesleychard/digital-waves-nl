...
const VALIDATION_SCHEMA = Yup.object().shape({
  ...
  DOB: Yup.date()
    ...
    .nullable()
    .default(undefined)
    .min(new Date('2002-12-03'), 'Student must not be older than 18 on December 3, 2021 to enter.')
    .max(new Date('2008-12-03'), 'Student must be at least 13 years old by December 3, 2021 to enter.'),
  CITY: Yup.string()
  ...
  GRADE: Yup.number()
    ...
    .min(6, 'Student\'s grade cannot be lower than 6.')
...
const ContestRegister = (): ReactElement => {
          ...
          if (participantIndex >= 0 && parentIndex >= 0) {
            if (mailchimpState.submissions[participantIndex].code === 'error') {
              const registeredError =
                'Oops! According to our records you\'ve already registered for Digital Waves 2021. '
            ...
            ? (
              <>
                  ...
                  duplicateParentWarning
                    ? (
                      <Typography className={classes.typographyDuplicateParent}>
                        ...
                        <br /><br />
                        The parent/guardian email associated with this registration is already subscribed to contest updates.
                        To reduce clutter in their inbox, they will not receieve the registration information package again.
                        <br /><br />
                ...
                <Typography className={classes.form}>
                  <strong>
                    Thanks for registering to participate in Digital Waves 2021!
                  ...
                  render={({ field }) => (
                    <>
                      <FormControlLabel
                        ...
                        label="I give my consent to Digital Waves to contact the above student with information about the 2021 experience. *"
                      />
                      {
                        errors.CONSENT
                          ? (
